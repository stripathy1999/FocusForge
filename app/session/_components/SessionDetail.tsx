        ...
        <section className="rounded-2xl border border-zinc-200 bg-white p-6 shadow-sm">
          ...
          <div className="flex flex-wrap gap-3">
            <button
              ...
              disabled={exportingJournal || !!journalUrl}
              className="px-4 py-2 text-sm font-semibold rounded-lg text-white transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90"
              style={{ 
                fontFamily: 'var(--font-jura), sans-serif',
                backgroundColor: journalUrl ? '#10b981' : '#32578E'
              }}
            >
              {exportingJournal ? 'Exporting...' : journalUrl ? '✅ Exported' : 'Export to Opennote Journal'}
            </button>
            {journalUrl && (
              <a
                href={journalUrl}
                ...
                className="px-4 py-2 text-sm font-semibold rounded-lg text-white transition-all duration-200 hover:opacity-90"
                style={{ 
                  fontFamily: 'var(--font-jura), sans-serif',
                  backgroundColor: '#4777B9'
                }}
              >
                Open in Opennote
              </a>
            ...
            <button
              ...
              disabled={exportingPractice || practiceUrl === 'pending'}
              className="px-4 py-2 text-sm font-semibold rounded-lg text-white transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed hover:opacity-90"
              style={{ 
                fontFamily: 'var(--font-jura), sans-serif',
                backgroundColor: practiceUrl === 'pending' ? '#10b981' : '#32578E'
              }}
            >
              {exportingPractice ? 'Generating...' : practiceUrl === 'pending' ? '✅ Practice Set Generating' : 'Generate Practice Problems (Opennote)'}
            </button>
          </div>
          {exportError && (
